...
class CustomLoadingSignButton extends StatefulWidget {
  //required
  ...
  /// errored state
  final CustomLoadingSignButtonController controller;
  ...
  /// if given a [CustomLoadingSignButtonController], this widget can use the [moveToScreen]
...
class _LoadginButtonState extends State<CustomLoadingSignButton>
  ...
  void initState() {
    ...
    super.initState();
    // ignore: avoid_print
    WidgetsBinding.instance.addPostFrameCallback((_) => print("rebuild"));
  }
  ...
  @override
  void didUpdateWidget(covariant CustomLoadingSignButton oldWidget) {
    // ignore: todo
...
/// animation
class CustomLoadingSignButtonController {
